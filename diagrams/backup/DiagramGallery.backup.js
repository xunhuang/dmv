...
const DiagramGallery = () => {
  ...
  useEffect(() => {
    try {
      ...
      console.log('Retrieved from localStorage:', savedDescriptions);
          ...
          >
            ...
            <div className="p-2 text-sm text-gray-700">
              <div className="text-center mb-1 font-medium">
                <span className="text-gray-800">{index + 1}.</span> <span className="font-mono text-xs break-all">{image}</span>
              </div>
